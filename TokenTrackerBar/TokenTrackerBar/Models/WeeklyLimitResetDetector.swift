...
enum LimitResetProviderIconCatalog {
    ...
    static func svgFilename(for provider: String) -> String? {
        ...
        case "volcengine": return "volcengine.svg"
        default: return nil
        }
    }
}
...
extension UsageLimitsResponse {
    ...
    func limitWindowReadings() -> [(provider: String, windowKey: String, windowLabel: String, usedPercent: Double, resetAt: Double?)] {
        ...
        if let volcengine {
            addGeneric("volcengine", volcengine.configured, volcengine.error, [
                ("primary", "5h", volcengine.primaryWindow),
                ("secondary", "Weekly", volcengine.secondaryWindow),
                ("tertiary", "Monthly", volcengine.tertiaryWindow),
            ])
        }
